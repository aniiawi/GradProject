...
<div class="menu-mobile">
    ...
    <div class="working-area">
        ...
        <div class="cards">
                    ...
                    <li class="card">
                        <p class="course-description">Контроль и диагностика ИС - Тест №1 “Два алгоритма построения диагностических тестов"</p>
                        <div type="button" onclick="document.location='/question_page.php?lab_id=1'" class="course-goto"><p>Перейти</p> </div>
                    </li>

                    <li class="card">
                        <p class="course-description">Контроль и диагностика ИС - Тест №2 “Расчет программы локализации неисправностей"</p>
                        <div type="button" onclick="document.location='/question_page.php?lab_id=2'" class="course-goto"><p>Перейти</p> </div>
                    </li>

                    <li class="card">
                        <p class="course-description">Контроль и диагностика ИС - Тест №3 “Построение программы поиска неисправностей методом ветвей и границ"</p>
                        <div type="button" onclick="document.location='/question_page.php?lab_id=3'" class="course-goto"><p>Перейти</p> </div>
                    </li>

                    <li class="card">
                        <p class="course-description">Контроль и диагностика ИС - Тест №4 “Построение программы поиска неисправностей методом динамического программирования"</p>
                        <div type="button" onclick="document.location='/question_page.php?lab_id=4'" class="course-goto"><p>Перейти</p> </div>
                    </li>
