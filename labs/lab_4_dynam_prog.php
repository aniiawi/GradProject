...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 4 Динамическое программирование  - Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №4 “Построение программы поиска неисправностей методом динамического программирования”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR4_dynam_prog.pdf" ></iframe>
           <!-- <p class="text-bod"> Скачать программы, указанные в тексте лабораторной работы, можно по ссылке  </p><a href="https://github.com/307-labs/lab3_grad">https://github.com/307-labs/lab3_grad</a> -->
          <p><button type="submit" onclick="document.location='/question_page.php?lab_id=<?=$_GET['lab_id']; ?>'" class="goto-test">Пройти тест для самопроверки</button></p>
