...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 4 Прямой поиск  - Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №4 “Методы прямого поиска в задачах условной минимизации”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR4_pr_usl.pdf" ></iframe>
