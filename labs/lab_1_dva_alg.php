...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 1 Два алгоритма- Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №1 “Два алгоритма построения дианостических тестов”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR1_dva_alg.pdf" ></iframe>
