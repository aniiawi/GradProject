...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 2 Локализация неисправностей- Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №2 “Расчет программы локализации неисправностей”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR2_loc_prog.pdf" ></iframe>
          <!-- <p class="text-bod"> Скачать программы, указанные в тексте лабораторной работы, можно по ссылке  </p><a href="https://github.com/307-labs/lab1_odnom">https://github.com/307-labs/lab1_odnom</a>-->
