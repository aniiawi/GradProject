...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 2 Прямой поиск- Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №2 “Алгоритмы прямого поиска в многомерной минимизации”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR2_pr_poisk.pdf" ></iframe>
