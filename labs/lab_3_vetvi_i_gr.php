...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 3 Ветви и границы - Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №3 “Построение программы поиска неисправностей методом ветвей и границ”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR3_vetvi_i_gr.pdf" ></iframe>
