...
<html lang="ru">
  <head>
    ...
    <title>Лабораторная работа 3 Градиентные методы - Веб-портал по лабораторным работам МАИ</title>
...
<div class="menu-mobile">
      ...
      <div class="working-area">
        ...
        <p class="desktop-lab">Лабораторная работа №3 “Градиентные методы оптимизации”</p>
        <div class="lab_body">
          <iframe src="/pdfs/LR3_grad.pdf" ></iframe>
